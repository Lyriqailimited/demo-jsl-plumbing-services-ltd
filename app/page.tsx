export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0f172a', color: '#f8fafc' }}>
      <section style={{ background: 'linear-gradient(135deg, #1d71b8 0%, #383f92 100%)', padding: '80px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="tel:01414061658" style={{ background: 'rgba(0,0,0,0.2)', color: 'white', padding: '14px 32px', borderRadius: 12, fontWeight: 700, fontSize: '1rem', textDecoration: 'none', display: 'inline-block', border: '1px solid rgba(255,255,255,0.2)' }}>
              Call 0141 406 1658
            </a>
          </div>
        </div>
      ...
      <section style={{ padding: '80px 24px', background: '#0c1426' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: '#94a3b8', marginBottom: 48 }}>Comprehensive solutions across Glasgow</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 24 }}>
            <div key="Leaking taps" style={{ background: '#132f4c', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 32, textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: '#f8fafc' }}>Leaking taps</h3>
            </div>
            <div key="Broken toilets" style={{ background: '#132f4c', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 32, textAlign: 'center' }}>
              <div style={{ width: 48, height: 48, background: 'rgba(37, 99, 235, 0.2)', borderRadius: 12, margin: '0 auto 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🔧</div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: '#f8fafc' }}>Broken toilets</h3>
            </div>
            <div key="Burst pipes" style={{ background: '#132f4c', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 32, textAlign: 'center' }}>
              <div style={{ width: 48, height: 48, background: 'rgba(37, 99, 235, 0.2)', borderRadius: 12, margin: '0 auto 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🔧</div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: '#f8fafc' }}>Burst pipes</h3>
            </div>
            <div key="Electric shower installation and repair" style={{ background: '#132f4c', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 32, textAlign: 'center' }}>
              <div style={{ width: 48, height: 48, background: 'rgba(37, 99, 235, 0.2)', borderRadius: 12, margin: '0 auto 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🔧</div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: '#f8fafc' }}>Electric shower installation and repair</h3>
            </div>
            <div key="General plumbing" style={{ background: '#132f4c', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 32, textAlign: 'center' }}>
              <div style={{ width: 48, height: 48, background: 'rgba(37, 99, 235, 0.2)', borderRadius: 12, margin: '0 auto 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🔧</div>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: '#f8fafc' }}>General plumbing</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 24px', background: 'linear-gradient(135deg, #1d71b8 0%, #383f92 100%)', textAlign: 'center' }}>
